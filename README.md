...
На железе канал ещё не гонялся. Установщика на флешку нет. SSH и IP поверх звука специально не делаются — они требуют тот самый сетевой стек, который в этот момент сломан.
